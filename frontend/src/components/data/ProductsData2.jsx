  ...
  const TarinatJaTehtavat = [
    {
      ...
      description: (
        <>
          Hyppää mukaan Digiseikkailun työkirjaan! Digiseikkailun tuoteperhe
          tarjoaa opettajalle TVT- ja medialukutaitojen opetukseen selkeitä ja
          helppokäyttöisiä materiaaleja. Digiseikkailun Tarinat ja tehtävät
          -työkirjassa oppilaat pohtivat erilaisia arkipäivän tilanteita median
          parissa. Tarinoiden kuvista ja vihkoseen kerätystä sanastosta on
          helppo ymmärtää, miten aihe liittyy omaan elämään ja siirtää taito
          yhteisen keskustelun kautta käytäntöön. TVT- ja mediataitojen
          opetuksen keskiössä on tiedonalan kieli: käsitteet ja sanasto, joilla
          alan asioista puhutaan. Materiaali tukee opettajaa ja ohjaa näin kohti
          kielitietoista opetusta. Materiaali sopii omaksi vihkoksi esim. suomen
          kielen ja kirjallisuuden tunneille ja valmiiksi materiaaliksi TVT- ja
          mediataitokerhoihin tai valinnaiskursseille. Myös luokkatyössä oman
          ryhmän parissa voi luokanopettaja hyödyntää vihkon antia käydessään
          läpi perustietoja netiketistä, tiedonhankinnasta,
          viestittelytaidoista, sopivasta ruutuajasta, valeuutisista ja
          tietoturvasta. Parhaiten vihko sopii jo sujuvan lukutaidon
          saavuttaneiden lasten kanssa työskentelyyn. Iloisia hetkiä työkirjan
          parissa! Digiseikkailu Tulevaisuuden taitoja tarinoin. <br />
          <br />
          Työkirja sisältää monilukutaitoa vahvistavan lautapelin sekä 10
          tarinaa empatia-, teknologia- ja mediataidoista. Joka tarinaan kuuluu
          sanasto, yhdessä pohdittavia kysymyksiä sekä kynä-paperi tehtäviä.
          Tarinoissa ja tehtävissä oppilas peilaa media- ja teknologiataitoja
          arjen tilanteiden kautta ja kertaa opitun käsitteen tehtäviä
          tekemällä. Digiseikkailun oppimisympäristön kanssa aihetta voidaan
          syventää tarinaan liittyvillä tehtävillä hahmojen maailmoista esim.
