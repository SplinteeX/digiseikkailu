  ...
  const Tehtävät = [
    ...
    },
    {
      ...
      Tekstit: [
        ...
        "1. Listaa karttaan kaikki median muodot mitä käytät. netti – mitä teet netissä? radio – mitä kuuntelet? tv – mitä katsot? sanomalehdet – mitä lehtiä luet?",
        "2. Listaa suosituimmat sovelluksesi puhelimesta. Kerro miksi käytät juuri niitä?",
        "3. Missä käytät suosikkimedioitasi? kotona/koulussa/kavereiden kanssa/harrastuksissa jne.",
        "4. Miksi käytät mediaa? Pohdi ja kirjoita/piirrä mihin tarkoitukseen mitäkin mediaa käytät? Haluatko: näkyä/kuulua? vaikuttaa asioihin? löytää samankaltaisia/keskustella? viihtyä ja kuluttaa aikaa?",
        "5. Minkälaisena sinun oma mediajälkesi näyttäytyy? Googlaa itsesi omalla nimelläsi. Mihin palveluihin olet kommentoinut? Mistä kuviasi voi löytää? Pohdi, tiedätkö tarkasti kaikista käyttämistäsi palveluista säännöt ja tietosuojakäytänteet?",
        "6. Tee karttasi joko paperille piirtäen tai digiposterina ajatuskarttasovelluksena. Hyviä ajatuskarttasovelluksia ovat mm. Popplet, Mindmup ja MindMeister",
      ],
