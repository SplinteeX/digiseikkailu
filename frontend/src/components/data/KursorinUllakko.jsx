  ...
  const Tehtävät = [
    {
      ...
      puolTekstit: [
        "Ruokailu<br><br>Kaikki esineet, jotka eivät liity ruokaan tai kattaukseen tulisi pitää poissa pöydältä: avaimet, pikkulaukut, aurinkolasit, ja ennen kaikkea puhelimet.",
        "Älä tekstaile pöydässä!<br><br>Jos olet tilanteessa, jossa pahoittelisit kohteliaasti mennäksesi vessaan, sinun tulisi poistua kohteliaasti myös ennen kuin tartut puhelimeesi.",
        "Kaiuttimen käyttö<br><br>Kerro puhujalle, että sinulla on kaiutin päällä. Älä käytä kaiutinta, ellet ole toimistolla kokouksessa, johon joku osallistuu etänä. Varoita puhujaa siitä, että muita on läsnä ja sulje ovi. Kaiuttimen pitäminen täysillä silloin, kun tarkistat ääniviestejäsi, on ärsyttävyyden huippu.",
        "Sähköpostit asiallisesti<br><br>Älä lähetä sähköpostia, jossa sanot vain ”Moi!” Jos sinulla ei ole muuta sanottavaa sähköpostivastauksessasi kuin ”Kiitos!”, älä lähetä sitä. Täytät vain toisten Saapuneet-kansiota.",
        "Katso henkilöä eikä kännykkää!<br><br>Pidä puhelin poissa, kun keskustelet kasvotusten. Kun keskustelet jonkun kanssa kasvotusten, älä vilkuile samalla puhelintasi nähdäksesi, kuka yrittää tavoitella sinua.",
        "Isot kirjaimet ja liitteet harkiten!<br><br>Mitä ei pidä tehdä kirjoittaessaan sähköpostia: huutaa käyttämällä pelkkiä isoja kirjaimia, käyttää värillisiä fontteja ja hymiöitä, liittää viestiin isoja liitetiedostoja, lähettää viestiä eteenpäin, ellei se ole perusteltua.",
        "Puhelin piiloon ja ole läsnä<br><br>Kunnioita opettajaa ja vanhempiasi käytöksellä. Älä tarkista henkilökohtaisia laitteitasi sellaisen kokouksen oppitunnin tai kokouksen aikana, johon osallistuu opettajasi, vanhempasi joku muu joka yrittää keskustella kanssasi.",
        "Vastaa asiallisesti<br><br>erro puhelimeen nimesi. Älä vastaa vain “Moi!” tai “Haloooo?” Kun vastaat puhelimeen vaikka toisen ihmisen puhelimeen, kerro nimesi ja kenen puhelimeen henkilö on soittanut: ”Hannelen puhelimessa Jennifer paikalla.”",
        "Lyhyet ääniviestit<br><br>Kun jätät ääniviestiä, kerro koko nimesi ja numerosi. Kerro ytimekkäästi, miksi soitat. Toista ensimmäinen vaihe ja hyvästele. Pidä viesti hyvin lyhyenä.",
        "Pidä äänettömällä koulussa<br><br>Pidä puhelimesi äänettömällä. Jos jätät kännykkäsi laatikkoosi/putpettiisi, laita se äänettömälle. Varsinkin jos soittoäänesi on jokin räväkkä rokkibiisi.",
        "Puhelin kävellessä?<br><br>Seuraa liikennettä äläkä selaa puhelintasi. Nosta pääsi havainnoimaan kadun ylityksissä jotta et jäisi auton alle. Pysyttele jalkakäytävän oikealla reunalla äläkä tee äkkipysähdyksiä. Älä pysähdy tekstaamaan tai tarkistamaan sähköpostia kun ylität tietä!",
        "Musiikki vain omille korville<br><br>Älä soita musiikkia liian kovalla. Jos käytät soitintasi korvanappien kanssa, lähelläsi olevat henkilöt kuulevat soittolistasi ja se kuulostaa siltä kuin DJ:nä toimisi pieni ärsyttävä kärpänen! Musiikkia kuunnellessa on hyvä ottaa muut huomioon, etenkin julkisissa tiloissa.",
        "Puhelut ja viestit omana tietona<br><br>Vältä julkisia puhelinkeskusteluja varsinkin salaisista asioistasi. Älä puhu puhelimeen odotustilassa, hotellin uloskirjautumisjonossa, ravintolassa, junassa tai, luoja varjelkoon, vessakopissa. Älä näytä henkilökohtaisia viestejäsi tai toisten kirjoittamia viestejä muille.",
        "Älä häiritse viestittelemällä<br><br>Noudata tätä pikaviestinnän etikettiä. Kysy aina, onko nyt hyvä hetki chattailla. Ota huomioon toisten ihmisten aikataulut ja nukkumaanmenoajat.",
        "Vältä huutamasta puhelimeen<br><br>Älä huuda puhelimeen. Vaikka sinä et kuulisikaan linjan toisessa päässä olevaa henkilöä kovin hyvin, se ei tarkoita sitä, ettei hän kuulisi sinua.",
        "Pidä rajat mediassa<br><br>Mieti tarkkaan, mitä kirjoitat. Älä kirjoita sosiaaliseen mediaan arkaluontoisia henkilökohtaisia asioita, varsinkin jos koulukaverisikin voivat lukea kirjoituksesi.",
      ],
    ...
    },
    {
      ...
      Tekstit: [
        ...
        "1. Listaa karttaan kaikki median muodot mitä käytät.<br><br>Netti – mitä teet netissä? radio – mitä kuuntelet? tv – mitä katsot? sanomalehdet – mitä lehtiä luet?",
        "2. Listaa suosituimmat sovelluksesi puhelimesta.<br><br>Kerro miksi käytät juuri niitä?",
        "3. Missä käytät suosikkimedioitasi?<br><br>kotona/koulussa/kavereiden kanssa/harrastuksissa jne.",
        "4. Miksi käytät mediaa?<br><br>Pohdi ja kirjoita/piirrä mihin tarkoitukseen mitäkin mediaa käytät? Haluatko: näkyä/kuulua? vaikuttaa asioihin? löytää samankaltaisia/keskustella? viihtyä ja kuluttaa aikaa?",
        "5. Minkälaisena sinun oma mediajälkesi näyttäytyy?<br><br>Googlaa itsesi omalla nimelläsi. Mihin palveluihin olet kommentoinut? Mistä kuviasi voi löytää? Pohdi, tiedätkö tarkasti kaikista käyttämistäsi palveluista säännöt ja tietosuojakäytänteet?",
        "6. Tee karttasi joko paperille piirtäen tai digiposterina ajatuskarttasovelluksena.<br><br>Hyviä ajatuskarttasovelluksia ovat mm. Popplet, Mindmup ja MindMeister",
      ],
    ...
    },
    {
      ...
      puolTeksti:
        "Tarinassa käsitellään<br><br>digi- ja medialaitteiden historiaa ja pohditaan, millaista elämä olisi ilman digilaitteita. Voiko ilman digilaitteita selvitä?",
      Tekstit: [
    ...
    },
    {
      ...
      Tekstit: [
        "Kahden päivän haaste<br><br>Millaista oli aika ennen älypuhelimia?",
        "Kirjoita haasteestasi päiväkirjaa ja kerro koulussa, miten pärjäsit ja mitä uutta kenties koit ja huomasit.",
        "Kirjoita päiväkirjaa seuraavasti<br>Huomasin, että kun älypuhelin ja internet jäivät hetkeksi pois, niin…<br>---------------<br>---------------<br>---------------",
      ],
      numeroLista: [
    ...
    },
    {
      ...
      puolTeksti:
        "Millaista elämä on ollut ennen internettiä.<br>Missä järjestyksessä teknologisia laitteita on tullut suomalaisten käyttöön<br>Ainoastaan älylaitteilla ei kannata täyttää koko elämää",
      Tekstit: [
    ...
    },
    {
      ...
      Tekstit: [
        "1. Kolme hyvää asiaa ja huippukohta<br><br>Mietitään päivästä kolme hyvää asiaa. Toinen kiitollisuuden ajattelun herättäjä, on päivän huippukohta. “Mikä oli päivän paras hetki?” tai ”Mikä asia sujui tänään hyvin?”. Kuitenkin jos päivässä on ollut suuria, vaivaavia huolia, niin ne on myös hyvä käsitellä.",
        "2. Kiitollisuuspurkki<br><br>Kiitollisuuspurkkiin kerätään asioita mistä olemme kiitollisia viikon ajalta.<br><br>Viikon lopuksi ne luetaan yhdessä. Apukysymyksinä:<br><br>“Mikä sai minut nauramaan? Mikä meni hyvin? Kuka auttoi minua tänään?”<br><br>Lauseet voivat myös olla jatkettavia. ”Olen tänään iloinen siitä, että..” tai ”Minusta oli tänään ihanaa, kun..”.<br><br>Kiitollisuuden aiheet ovat yhteisiä, eikä tarkoitus ole laskea kuinka monta kukin on kirjoittanut viikon aikana. Lapset voivat olla myös kiitollisia, aikuisen mielestä, tosi kummallisista asioista ja sama toisinpäin. Kiitollisuuden aiheita ei myöskään vertailla, ettei kenellekään tule tunnetta, että hän tuntee kiitollisuutta väärin tai sisarus osaa osoittaa kiitollisuutta ”paremmin”.",
        "3. Kiitollisuuspäiväkirja<br><br>Kiitollisuuspäiväkirja on monelle tutuin kiitollisuusharjoitus. Siihen kirjataan päivittäin, kolme kertaa tai kerran viikossa niitä asioita, mistä on kiitollinen. Tutkimusten mukaan ”tehokkain” tapa pitää kiitollisuuspäiväkirjaa, on tehdä sitä kolmesti viikossa.",
        "4. Kiitollisuusviesti/kortti/kirje<br><br>Kiitollisuuden osoittaminen nostaa myös omaa kiitollisuuden tunnetta. Sen lisäksi, että kiitollisuutta osoittaa sanoin, voi sen tehdä viestillä, kortilla ja kirjeellä. Käytte luokan kanssa retkellä jossain kohteessa. Miettikää yhdessä, mitä kaikkea kivaa päivän aikana on tapahtunut ja kertaamme hyviä hetkiä. Sitten todetaan yhdessä: ”Lähetetäänkö kiitosviesti?”. ”Joo.” ”Mitä haluaisit siihen kirjoittaa?” Kirjoittakaa yhdessä, kuinka kivaa oli käydä, päivän huippukohdat ja kiitokset. Lopuksi luen sen läpi kaikille. Viestistä tulee hyvä olo ja varmasti myös vastaanottajalle. Voit tehdä pienen harjoituksen heti nyt. Mieti ketä voisit kiittää heti tällä hetkellä. Jos henkilö ei ole läsnä, kirjoita hänelle tekstitekstiviesti (tai käytä muuta pikaviestintävälinettä). Lähetä viesti.",
        "5. Kiitollisuuskiikarit ja hyvän lokikirja<br><br>Voit askarrella kiitollisuuskiikarit (pahvista tai vessapaperirullista), joilla on tarkoitus etsiä kaikkea hyvää. Tähän voi liittää laivailuteeman, jossa etsitään hyviä asioita kiikareilla ja kirjoitetaan bongaamia hyviä asioita/tapahtumia/hetkiä kapteenin lokikirjaan. Päivän tai viikon jälkeen lapset voivat lukea otteita kapteenin lokikirjasta miehistölle (muulle luokalle).",
        "6. Hyvien hetkien uusinta<br><br>Sanotaan, että asioissa ei saa velloa eikä vatvoa, mutta on yksi poikkeus. Hassut tapahtumat, nauruntäyteiset muistot ja hyvät hetket ovat tehty vellomista, uudelleen muistelua ja vatvomista varten. Niitä saa pyörittää mielessään uudestaan ja uudestaan, sillä niiden muistelu tekee hyvää aivoillemme ja niiden jakaminen vahvistaa ihmissuhteitamme. Joka päivä olisi hyvä miettiskellä ainakin kymmenen minuuttia jotain hyvää tapahtumaa.",
        "7. ”Minä keksin” – kiitollisuudenosoitus<br><br>Parasta on ne ideat, jotka tulevat suoraan oppilailta. Annetaan kaikille mahdollisuus myös itse miettiä, miten juuri hän haluaa osoittaa tai harjoittaa kiitollisuutta.",
        "8. Käännetään kurja juttu kiitollisuudeksi<br><br>Kuvitellaan että yrität ehtiä bussiin. Kaadut pahasti, lyöt pääsi ja nenäsi ja kädet menevät ihan verille. Liikenne jatkaa kulkua ympärilläsi. Nyt nolottaa, näkiköhän kukaan. Kaveri auttaa sinut ylös. Koulupäiväkin menee nyt ihan pilalle. Nenäkin on ihan veressä ja näytät räjähtäneeltä. Soitat vanhemmallesi joka hakee sinut terveyskeskukseen ja sieltä kotiin lepäämään. Läksyt saat kaveriltasi tekstarilla. Pysähdytään. Mitkä kaikki asiat ovat kuitenkin hyvin? Auto ei ajanut päältäsi. Nenän verenvuodon saa loppumaan. Oli hyvä kaveri joka auttoi minut ylös. Sait viettää rauhassa aikaa kotona. Sait kuitenkin koulutehtävät ja hoidettua kouluhommat. Nenäkin on parempi ja käsien haavat ovat ummessa. Tilanteessa oli lopulta enemmän positiivista kuin negatiivista. Kun opetellaan kääntämään kaikki mahdollinen parhain päin, emme jää kantamaan ikäviä mietteitä. Loppu hyvin, kaikki hyvin.",
      ],
    ...
    },
    {
      ...
      Tekstit: [
        "1. Mikä on sinun sisumoottorisi?<br><br>Mieti, mikä auttaa sinua jaksamaan, kun alkaa tuntua vaikealta. Se voi olla lempimusiikkisi, ajatus siitä, että selviät haasteesta, tai vaikka hauska elokuva.",
        "2. Sisukkaiden tarinoiden etsiminen<br><br>Etsi tarinoita ihmisistä, jotka ovat olleet tosi sisukkaita. Voit löytää niitä kirjoista, lehdistä tai netistä. Kerro sitten kavereillesi, mikä tarinassa inspiroi sinua.",
        "3. Oma vahvuus ja sisäinen kannustus<br><br>Muista, että olet hyvä monissa asioissa! Joskus kun tuntuu, että muut eivät usko sinuun, sisäinen kannustava äänesi auttaa sinua jaksamaan.",
        "4. Kasvun asenne<br><br>Usko, että voit oppia ja kehittyä, vaikka välillä epäonnistuisitkin. Epäonnistumiset ovat oppimistilaisuuksia, eivätkä merkki siitä, että sinun pitäisi luovuttaa.",
        "5. Epäonnistuminen ei ole maailmanloppu<br><br>Joskus kaadutaan, mutta se ei haittaa. Sisu tarkoittaa sitä, että nouset ylös ja yrität uudestaan. Epäonnistuminen on vain osa matkaa kohti tavoitetta.",
        "6. Tunnista terve sisukkuus<br><br>Joskus on okei myös luovuttaa. Jos jokin asia on liian vaikea tai vie liikaa aikaa muilta tärkeiltä jutuilta, voi olla viisasta miettiä muita vaihtoehtoja.",
