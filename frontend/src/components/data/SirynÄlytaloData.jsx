  ...
  const Tehtävät = [
    {
      ...
      Tekstit: [
        ...
        "Myöhemmin listaan lisättiin laki<br><br>Robotti ei voi vahingoittaa ihmiskuntaa eikä antaa ihmiskunnan vahingoittua.",
    ...
    },
    {
      ...
      Tekstit: [
        ...
        "Robotit kotona<br><br>Nyt on olemassa robotteja, jotka voivat auttaa kotitöissä, kuten robotti-imureita. Ne voivat itsestään imuroida lattiat ja joskus jopa leikata nurmikkoa puolestasi.",
        "Robotit terveydenhuollossa<br><br>On robotteja, jotka auttavat lääkäreitä leikkauksissa tai toimivat apuna sairaaloissa.",
        "Tutkimus- ja pelastusrobotit<br><br>Robotteja käytetään myös tutkimuksessa, esimerkiksi veden alla tai avaruudessa, missä ihmisille olisi liian vaarallista mennä. Ne voivat myös auttaa etsintä- ja pelastustehtävissä, esimerkiksi löytämään ihmisiä romahtaneiden rakennusten alta",
        "Robotit muissa tehtävissä<br><br>Laboratorioissa robotit auttavat näytteiden käsittelyssä, varsinkin kun on paljon näytteitä käsiteltävänä päivittäin.",
        "Robotit viihteessä ja harrastuksissa<br><br>Lelurobotit<br><br>Tiedätkö, robotit voivat olla myös leluja! On olemassa robotteja, joita voi ohjata kaukosäätimellä tai sovelluksella. Ne voivat liikkua, puhua ja joskus jopa oppia uusia temppuja.",
        "Pelirobotit<br><br>Joissain tietokone- ja konsolipeleissä käytetään robottihahmoja. Nämä robotit voivat olla pelin sankareita tai pahiksia, ja ne tekevät pelistä jännittävän.",
        "Robottikoira ja muut lemmikit<br><br>On olemassa robotteja, jotka näyttävät ja käyttäytyvät kuin oikeat lemmikit, kuten koirat. Nämä robottikoirat osaavat esimerkiksi kävellä, haukkua ja jopa oppia temppuja.",
        "Palvelurobotit<br><br>Jotkut robotit auttavat ihmisiä arjessa, kuten sairaaloissa kuljettamalla lääkkeitä ja tarvikkeita. Ne voivat myös auttaa vanhuksia tai vammaisia heidän kotonaan.",
      ],
    ...
    },
    {
      ...
      Tekstit: [
        ...
        "Millaisissa ammateissa voitaisiin hyödyntää sitä, ettei robotti lähde ihmisen tunnetilaan mukaan? Se ei esimerkiksi suuttuisi koskaan.<br><br>Perustele.",
      ],
