  ...
  const Tehtävät = [
    ...
    },
    {
      ...
      Tekstit: [
        ...
        "Käyttäkää ennakoivaa lukutapaa:\n\n - mitä uutisesta voi päätellä kuvan perusteella?",
        "Kuvaa käsitellään seuraavaksi kolmella tavalla:\n\n - äänimaailmana,\n\n - sarjakuvana ja\n\n- digitarinana.",
        "Palauttakaa mielestänne onnistunein versio opettajalle",
        "Äänimaailma\n\n- Luokaa kuvalle äänimaailma. Millaisia ääniä kuuluu kuvasta? Tuottakaa ja nauhoittakaa äänimaailma puhelimella tai tabletilla.",
        "Sarjakuva\n\n- Tehkää sarjakuva uutiskuvan tilanteesta. Mitä tapahtui juuri ennen kuvan ottohetkeä? Mitä tapahtuu seuraavaksi?",
        "Digitarina\n\n- Tehkää digitarina kuvan tilanteesta. Voitte toteuttaa tarinan joko näyttelemällä tai piirtämällä ja äänittämällä. Hyviä sovelluksia digitarinan tekemiseen ovat mm. iMovie, Quik tai Spark video.",
    ...
    },
    {
      ...
      Tekstit: [
        ...
        "Tekoälyn käyttö tiedonhaussa\n\n- Chatbotit kuten Doge tai ChatGPT: Voit myös kysyä tietoja tekoälyltä, kuten Dogelta. Kirjoita vain kysymyksesi, ja minä etsin sinulle vastaukset!\n\nNäillä vinkeillä tiedonhaku netistä on helpompaa ja nopeampaa. Ja jos et löydä etsimääsi, voit aina kysyä minulta apua!",
        "Vinkit tiedonhakuun\n\nNäillä vinkeillä ja vihjeillä opit löytämään tietoja helposti ja nopeasti.",
      ],
    ...
    },
    {
      ...
      Tekstit: [
        ...
        "Tunnista luotettava tieto\n\nEtsi ja yhdistä toisiinsa vastakohtaparit joihin luotettavan tiedon tutkija törmää.",
      ],
      Unity:
