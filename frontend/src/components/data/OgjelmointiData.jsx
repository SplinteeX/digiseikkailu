export const OhjelmointiData = () => {
  const Tehtävät = [
    ...
    },
    {
      ...
      Kategoria: "OhjelmointiPolku",
      Teksti:
        "Auta Doge, Häsä ja Laama maaliin! Lisää viivoille ohjeet.\n\n Esimerkki:\n\n Liiku 9 ruutua\n\n Käänny oikealle. Käänny vasemmalle.\n\n Paina lopuksi  nappia.",
      Unity:
    ...
    },
    {
      ...
      Tekstit: [
        ...
        "Esim.\n\n Liiku 9 eteenpäin.\n\n Käänny vasemmalle.\n\n Liiku 3 eteenpäin.\n\n Paina lopuksi 'Suorita' näppäintä.",
      ],
      Unity:
